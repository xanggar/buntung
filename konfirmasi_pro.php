...
<!-- Contact Form Start -->
       <?php
	       $pp=mysql_fetch_array(mysql_query("SELECT * FROM pesan_packages WHERE id_pesan_packages='".$_GET[idid]."'"));
	       $p=mysql_fetch_array(mysql_query("SELECT * FROM packages WHERE id_package='".$pp[id_package]."'"));
								
								list($bb, $mm, $dd)=split ("[- :]", $pp['tanggal_pesan']);
								$tgl=$dd."-".$mm."-".$bb;

							?>
							<form action="bayar.php?_page=myaccount&id_pesan=<?php echo $_GET[idid]; ?>" method="post" name="tambah" id="tambah">
							 <table width="100%" border="0" cellpadding="7" cellspacing="0">
								 <tr>
									 <td colspan="3" align="left" valign="middle">&nbsp;</td>
									</tr>
								 <tr>
									 <td width="23%" align="left" valign="middle">Nama Paket Poin</td>
										<td width="2" align="center" valign="middle">:</td>
										<td width="75%" align="left" valign="middle">
										 <?php echo $p[nama_package]; ?>
										</td>
									</tr>
								 <tr>
									 <td width="23%" align="left" valign="middle">Jumlah Poin</td>
										<td width="2" align="center" valign="middle">:</td>
										<td width="75%" align="left" valign="middle">
										 <?php echo $p[jumlah_bid]; ?>
										</td>
									</tr>
								 <tr>
									 <td width="23%" align="left" valign="middle">Harga</td>
										<td width="2" align="center" valign="middle">:</td>
										<td width="75%" align="left" valign="middle">
										 Rp.<?php echo number_format($p['harga_package'], 0, ',', '.'); ?>,-
										</td>
									</tr>
								 <tr>
