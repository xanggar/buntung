			 ...
			 <tr>
				 <td width="580px" align="center" valign="top"> <!-- Untuk Utama --> 
					 ...
					 <?php
						...
						$cek=mysql_fetch_array(mysql_query("SELECT * FROM member WHERE page='".$_GET[page]."'"));
						...
						{
						 $edit=mysql_query("UPDATE member SET status='1' WHERE page='$_GET[page]'");
							if($edit)
							{
								?>
								<script language="javascript">
									document.location="register3.php?_page=<?php echo $_GET[page]; ?>";
								</script>
								<?php
							}
						}
