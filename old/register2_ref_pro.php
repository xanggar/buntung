			 ...
			 <tr>
				 <td width="580px" align="center" valign="middle"> <!-- Untuk Utama --> 
					 <?php
						...
						?>
						<form name="simpan" action="register2_ref.php?_page=<?php echo $_GET[_page]; ?>&hal=regis" method="post">
						 ...
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Referal yang Anda masukkan Salah.<br></td>
							 </tr>
							 <tr>
						...
						else if(empty($_POST[username]))
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Tolong masukan Username Anda.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if($user>0)
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Username sudah pernah digunakan.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if((strlen($_POST[username])<4) or (strlen($_POST[username])>10))
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Username Anda harus 4-10 Char.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if(empty($_POST[password]))
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Tolong masukan Password Anda.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if(empty($_POST[password2]))
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Tolong masukan Konfirmasi Password Anda.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if (empty($_POST[hp]))
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="80%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi">Anda harus mengisi Nomor HP atau Nomor Telp Rumah.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else if($referal2==$username2)
						{
						 ?>
							<table cellpadding="7px" cellspacing="1px" style="border:1px solid #acbccc" width="100%">
							 ...
							 <tr align="center" valign="middle">
							  <td class="isi2">Referal tidak boleh sama dengan Username yang Anda masukkan.<br></td>
							 </tr>
							 <tr>
							  <td align="center" valign="middle" class="link_biru"><a href='javascript:simpan.submit()'>Kembali ke halaman sebelumnya</a></td>
							 </tr>
						...
						else
						{
						 ...
						 $regis="INSERT INTO member (username, password, email, gender, nama, hp, kode_area, telp, id_tujuan, alamat, referal, token, page) 
							        VALUES ('".$username2."', '".$masuk_pass."', '".$email3."', '".$gender."', '".$nama."', '".$hp."', '".$kode_area."', '".$telp."', '".$kota."', '".$alamat."', '".$referal2."', '".$tokenreg."', '".$tokenreg2."')";
						 //echo $regis; exit;
								...
								if($status)
								{
								 ?>
									<script language="javascript">
									 document.location="register2_ref_conf.php?_page=<?php echo $ambil_token[page]; ?>&hal=regis";
									</script>
									<?php
								} 
							}
