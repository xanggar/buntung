		 ...
		 <table cellpadding="0" cellspacing="0" width="100%" border="0">
			 <tr>
				 <td width="580px" align="center" valign="middle"> <!-- Untuk Utama --> 
					 <?php
						 $refref=mysql_fetch_array(mysql_query("SELECT username, page, referal FROM member WHERE page='$_GET[_page]'"));
						?>
					 <form action="register2_ref_pro.php?_page=<?php echo $_GET[_page]; ?>&_hal=regis" method="post">
							<table cellpadding="7px" cellspacing="0" width="100%" border="0">
								...
								<tr>
									...
									<input disabled="disabled" value="<?php echo $refref[username]; ?>" class="isi" type="text" size="25" />
									<input value="<?php echo $refref[username]; ?>" class="isi" name="referal" type="hidden" size="25" />
									</td>
								</tr>
								<tr>
