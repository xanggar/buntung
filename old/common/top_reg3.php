							 ...
							 <td align="right" valign="top">
								 <table cellpadding="0" cellspacing="0" width="162px" border="0">
									 ...
									 <tr <?php if($_GET[_hal]=="regis") { ?> style="background-image:url(images/menu2.png)" <?php } else { ?> style="background-image:url(images/menu1.png)" <?php } ?>>
										...
										<tr><td height="5px" colspan="2"></td></tr>
									 <tr <?php if($_GET[_hal]=="login") { ?> style="background-image:url(images/menu2.png)" <?php } else { ?> style="background-image:url(images/menu1.png)" <?php } ?>>
										 <td align="left" valign="top" colspan="2">
											 <table cellpadding="0" cellspacing="0" border="0" width="100%">
												 <tr>
														<td width="7%" align="left" valign="middle">&nbsp;</td>
														<td width="93%" height="25px" align="left" valign="middle"><a href="login.php?_hal=login" class="menu_atas" onMouseOver="style.textDecoration='underline'" onMouseOut="style.textDecoration='none'">My Account</a></td>
													</tr>
												</table>
											</td>
										</tr>
									 ...
									 <tr>
											 ...
											 <table cellpadding="0" cellspacing="0" width="100%" border="0">
												 <tr>
													 <td align="left" valign="middle" class="menu_item">
														 <img src="images/ok.png" align="absmiddle"><font class="angka">1</font> Registration Step 1
														</td>
													</tr>
												 <tr>
													 <td align="left" valign="middle" class="menu_item2">
														 Isi Kuisioner dibawah ini untuk mencatat semua kebutuhan Anda serta share pengalaman Anda dalam surfing di internet.
														</td>
													</tr>
												</table>
											</td>
										 ...
										 <td width="250px" align="center" valign="middle">
											 <table cellpadding="0" cellspacing="0" width="100%" border="0">
												 <tr>
													 <td align="left" valign="middle" class="menu_item">
														 <img src="images/ok.png" align="absmiddle"><font class="angka">2</font> Registration Step 2
														</td>
													</tr>
												 <tr>
													 <td align="left" valign="middle" class="menu_item2">
														 Silahkan mengisi data diri Anda dengan baik dan seksama, untuk memudahkan kami dalam melakukan verifikasi.
														</td>
													</tr>
												</table>
											</td>
										 ...
										 <td width="250px" align="center" valign="middle">
											 <table cellpadding="0" cellspacing="0" width="100%" border="0">
												 <tr>
													 <td align="left" valign="middle" class="menu_item">
														 <font class="angka">3</font> Registration Step 3
														</td>
													</tr>
												 <tr>
													 <td align="left" valign="middle" class="menu_item2">
														 Undang teman-teman Anda untuk bergabung di Buntung.Com dan bersenang-senang dalam berbelanja.
														</td>
													</tr>
												</table>
											</td>
