		 ...
		 <table cellpadding="0" cellspacing="0" width="100%" border="0">
			 <tr>
				 <td width="580px" align="center" valign="middle"> <!-- Untuk Utama --> 
					 <form action="register2_conf_pro.php?page=<?php echo $_GET[_page]; ?>" method="post">
							<table cellpadding="7px" cellspacing="0" width="100%" border="0">
								...
								<tr>
									<td align="left" valign="middle" class="isi">
										&nbsp; &nbsp; &nbsp;<input type="button" onClick="document.location='kirim_ulang.php?_page=<?php echo $_GET[_page]; ?>'" class="isi" value="Kirim Ulang">
