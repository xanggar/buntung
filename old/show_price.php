	...
	<tr>
	 <td align="center" valign="middle">
		 ...
		 <?php
			...
			{
   ?>
			<img onclick="window.alert('Anda harus login terlebih dahulu')" style="cursor:pointer" src="images/booking.png" align="absmiddle" />
			<?php			
			}
			?>
			<br /><br />
			<?php
			 $book=mysql_query("SELECT * FROM booking WHERE id_product='".$_GET[id]."'");
