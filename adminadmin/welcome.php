...
<table cellpadding="6px" cellspacing="0" style="border:1px solid #acbccc" width="700px">
 <?php
	$about=mysql_fetch_array(mysql_query("SELECT * FROM welcome"));
	$how=str_replace("<br>", "\r\n", $about[ket]);
	?>
  <tr bgcolor="#efefef">
	  <td align="left" valign="middle"><b><big>Form Setting Welcome Note</big></b></td>
	</tr>
	<tr>
	  <td align="left" valign="top" colspan="2" width="700px">
			<form name="ubah" method="post" action="welcome_pro.php">
