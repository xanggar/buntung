...
<table cellpadding="6px" cellspacing="0" style="border:1px solid #acbccc" width="700px">
  <?php
		 $email=mysql_fetch_array(mysql_query("SELECT * FROM email"));
		?>
  <tr bgcolor="#efefef">
	  <td align="left" valign="middle"><b><big>Form Setting Email (<?php echo $email[email]; ?>)</big></b></td>
	</tr>
	<tr>
	  <td align="left" valign="top" colspan="2" width="700px">
			<form name="ubah" method="post" action="setting_email_pro.php" enctype="multipart/form-data">
				<table cellpadding="6px" cellspacing="0" border="0" width="780px">
					<tr>
						<td align="left" valign="middle" width="23%">Email Tujuan *</td>
