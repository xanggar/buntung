...
?>
   <table cellpadding="10px" cellspacing="1px" border="0" width="400px">
     <tr>
      <td align="center" valign="middle" class="header_error">Edit Packages Bidding</td>
     </tr>
...
{
  $query="UPDATE packages SET nama_package='".$nama."', jumlah_bid='".$jumlah."', harga_package='".$harga."', tgl_update='".$tanggaltanggal."', admin='".$SES_USERNAME."' WHERE id_package='".$_GET[id_package]."'";
  ...
  { 
   ...
   <table cellpadding="10px" cellspacing="1px" border="0" width="800px">
     <tr>
      <td align="center" valign="middle" class="header_sukses">Edit Packages Bidding Berhasil</td>
     </tr>
	</table>
 ...
 { 
   ...
   <table cellpadding="10px" height="200px" cellspacing="1px" border="0" width="800px">
     <tr>
      <td align="center" valign="middle" class="header_error">Edit Packages Bidding Error</td>
     </tr>
	   <tr align="center" valign="middle">
