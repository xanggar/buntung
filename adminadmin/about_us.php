...
<table cellpadding="6px" cellspacing="0" style="border:1px solid #acbccc" width="700px">
 <?php
	...
	?>
  <tr bgcolor="#efefef">
	  <td align="left" valign="middle"><b><big>Form Setting About Us</big></b></td>
	</tr>
	<tr>
	  <td align="left" valign="top" colspan="2" width="700px">
			<form name="ubah" method="post" action="about_us_pro.php">
				<table cellpadding="6px" cellspacing="0" border="0" width="780px">
					<tr>
						<td align="left" valign="middle" width="23%">About Us</td>
						<td align="left" valign="middle" width="2%">:</td>
						<td align="left" valign="middle">
							<textarea rows="7" cols="85" name="about"><?php echo $about[about_us]; ?></textarea>
							</td>
					</tr>
					<tr>
						<td align="left" valign="middle" width="23%">More About</td>
						<td align="left" valign="middle" width="2%">:</td>
						<td align="left" valign="middle">
							<textarea rows="7" cols="85" name="more"><?php echo $about[more_about]; ?></textarea>
							</td>
					</tr>
					<tr>
						<td align="left" valign="middle" width="23%">Blockquote </td>
						<td align="left" valign="middle" width="2%">:</td>
						<td align="left" valign="middle">
							<textarea rows="7" cols="85" name="blockquote"><?php echo $about[quote]; ?></textarea>
							</td>
					</tr>
					<tr>
