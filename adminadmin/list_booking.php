...
<table width="800px" cellpadding="6px" cellspacing="0" border="0">
 <tr>
  <td align="left" valign="middle" width="50%"><b><big>Konfirmasi Pembayaran Booking dari Tranfer</big></b></td>
...
<table width="800px" cellpadding="6px" cellspacing="0" border="1px">
  <tr bgcolor="#efefef">
	  ...
	  <td align="center" valign="middle" width="100px" class="putih"><b>Nama Barang</b></td>
	...
	<?php
	$abc="SELECT * FROM booking WHERE status='1' ORDER BY tanggal_konfirmasi ASC";
	$res=mysql_query($abc);
	$n=1;
  ...
  <tr>
	  ...
	  <td align="center" valign="middle" width="100px" class="putih"><?php echo $barang[nama_barang]; ?></td>
					 ...
					 <table cellpadding="3px" cellspacing="0" width="100%">
						 ...
						 <tr>
							 <td align="left" valign="top" width="33%">Harga Paket</td>
								<td align="center" valign="top" width="2%">:</td>
							 <td align="left" valign="top" width="65%"><b>Rp.<?php echo number_format($beo['harga_booking'], 0, ',', '.'); ?>,-</b></td>
							</tr>
						</table>
				</div>
			</td>
	  <td align="center" valign="middle" width="50px" class="putih">
		  <table cellpadding="3px" cellspacing="0" width="100%">
			  <tr>
				  <td align="center" valign="middle" width="25%"><a href="approve_pembayaran_booking.php?id_bayar=<?php echo $beo['id_booking']; ?>" class="link_kecil">Approve</a></td>
				  <td align="center" valign="middle" width="25%"><a href="hapus_booking.php?id_bayar=<?php echo $beo['id_booking']; ?>" class="link_kecil">Tolak</a></td>
				</tr>
			</table>
		</td>
	</tr>
