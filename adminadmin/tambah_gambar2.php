  ...
  <tr bgcolor="#efefef">
	...
	<tr>
	  <td align="left" valign="top" colspan="2" width="700px">
			<form action="tambah_gambar_pro2.php?id=<?php echo $_GET[id]; ?>" method="post" enctype="multipart/form-data" name="tambah" id="tambah">
				<table cellpadding="6px" cellspacing="0" border="0" width="780px">
					<tr>
						<td align="left" valign="middle" width="23%">Tambah Gambar</td>
