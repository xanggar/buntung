...
<table cellpadding="6px" cellspacing="0" style="border:1px solid #acbccc" width="700px">
 <?php
	...
	?>
  <tr bgcolor="#efefef">
	  <td align="left" valign="middle"><b><big>Form Harga Poin</big></b></td>
	</tr>
	<tr>
	  <td align="left" valign="top" colspan="2" width="700px">
			<form name="ubah" method="post" action="setting_harga_poin_pro.php">
				<table cellpadding="6px" cellspacing="0" border="0" width="780px">
					<tr>
						<td align="left" valign="middle" width="23%">Harga 1 Poin</td>
						<td align="left" valign="middle" width="2%">:</td>
						<td align="left" valign="middle">
							<input type="text" value="<?php echo $harga[harga_poin]; ?>" name="harga" />
							</td>
					</tr>
					<tr>
