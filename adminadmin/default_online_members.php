...
<?php
 $j=mysql_fetch_array(mysql_query("SELECT * FROM default_ol_members WHERE id_om='1'"));
?>

<table align="center" vspace="middle" width="800px" cellpadding="6px">
 <tr>
	 <td align="left" valign="middle" width="50%"><b><big>Setting Default Online Members (<font color="#0066FF"><?php echo $j[jml_ol_members]; ?></font> orang)</big></b></td>
...
<table cellpadding="6px" cellspacing="0" border="0" width="800px">
	<tr>
	  <td align="left" valign="top" colspan="2" width="100%">
	    <form action="default_online_members_pro.php" method="post">
	     Default Online Members &nbsp; <input type="text" name="member" size="15">
