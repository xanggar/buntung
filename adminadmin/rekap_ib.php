...
<table width="800px" cellpadding="6px" cellspacing="0" border="0">
 <tr>
  <td align="left" valign="middle" width="50%"><b><big>Rekapitulasi Instant Buy</big></b></td>
...
<table width="800px" cellpadding="6px" cellspacing="0" border="1px">
  <tr bgcolor="#efefef">
	  ...
	  <td align="center" valign="middle" width="325px" class="putih"><b>Nama Barang</b></td>
	...
	<?php
	$abc="SELECT * FROM instant_buy WHERE status='1' ORDER BY tanggal_update ASC";
	$res=mysql_query($abc);
	$n=1;
  ...
  <tr>
	  ...
	  <td align="left" valign="middle" width="325px" class="putih"><?php echo $barang[nama_barang]; ?></td>
