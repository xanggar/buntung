...
<table width="800px" cellpadding="6px" cellspacing="0" border="0">
 <tr>
  <td align="left" valign="middle" width="50%"><b><big>Rekapitulasi Pembayaran Booking dari Tranfer</big></b></td>
...
<table width="800px" cellpadding="6px" cellspacing="0" border="1px">
  <tr bgcolor="#efefef">
	  ...
	  <td align="center" valign="middle" width="150px" class="putih"><b>Nama Barang</b></td>
	...
	<?php
	$abc="SELECT * FROM booking WHERE status='2' ORDER BY tanggal_konfirmasi ASC";
	$res=mysql_query($abc);
	$n=1;
  ...
  <tr>
	  ...
	  <td align="center" valign="middle" width="150px" class="putih"><?php echo $barang[nama_barang]; ?></td>
