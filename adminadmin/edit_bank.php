...
<?php
$user_id=$_GET[id];
$bank=mysql_fetch_array(mysql_query("SELECT * FROM rekening WHERE id_rekening='$_GET[id_bank]'"));
?>

<br /><br />

<form name="ubah" method="post" action="edit_bank_pro.php?id_bank=<?php echo $_GET[id_bank]; ?>">
  <table cellpadding="10px" cellspacing="0" border="0" width="800px" style="border:1px solid #acbccc">
	  <tr>
		  <td align="left" valign="middle" colspan="3"><b><big>Edit Bank</big></b></td>
		</tr>
		<tr>
		  <td align="left" valign="middle" width="23%">Nama Bank *</td>
			<td align="left" valign="middle" width="2%">:</td>
		  <td align="left" valign="middle"><input name="nama" size="45" value="<?php echo $bank[nama_bank]; ?>"></td>
		</tr>
		<tr>
		  <td align="left" valign="middle" width="23%">Nomor Rekening *</td>
			<td align="left" valign="middle" width="2%">:</td>
		  <td align="left" valign="middle"><input name="nomor" size="45" value="<?php echo $bank[nomor_rekening]; ?>"></td>
		</tr>
		<tr>
		  <td align="left" valign="middle" width="23%">Atas Nama *</td>
			<td align="left" valign="middle" width="2%">:</td>
		  <td align="left" valign="middle"><input name="atasnama" size="45" value="<?php echo $bank[atas_nama]; ?>"></td>
		</tr>
		<tr>
		  <td></td>
				<td></td>
		  <td align="left" valign="middle">
			  <input type="submit" value="Edit" style="cursor:pointer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
