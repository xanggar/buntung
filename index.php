...
<p><a href="welcome.php" class="link_biru">Read More</a></p>
<br />
		 ...
		 <table width="100%" height="150px" cellpadding="5px" cellspacing="0" style="border:1px solid #acbccc">
			 ...
			 <tr>
				 <td align="left" valign="top">
						...
						<p>
						<?php
						$jumlah_booking=mysql_num_rows(mysql_query("SELECT * FROM booking WHERE id_product='".$beo[id_product]."' AND (status='0' OR status='1')"));
						
						$aa=rand("6454", "8965");
						$aaa=$beo[id_kategori]."".$lebar.$aa;
						if(empty($USERNAME)&&$jumlah_booking<3)
						{
						?>
						<img src="images/tanya.png" align="top" onclick="window.alert('Anda harus login terlebih dahulu')" />
						<?php
						}
						else if(!empty($USERNAME)&&$jumlah_booking<3)
						{
						?>
